  ...
  function renderView() {
    container.innerHTML = `
      <div class="generator-view container fade-in-up" style="max-width: 500px; margin: 0 auto; padding-bottom: 3rem; text-align: center;">
        ...
        ${howItWorks({
          title: '¿Cómo funciona el Generador de Castigos?',
          intro: 'Te propone al azar un castigo para el que pierde la jornada, de un catálogo de 60 ideas de todo tipo: vergonzosas, creativas, deportivas y físicas.',
          steps: [
            'Pulsa <strong>Generar Castigo</strong> para ver una propuesta aleatoria.',
