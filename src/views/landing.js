    ...
    container.innerHTML = `
      <div class="landing-layout-brutalist fade-in-up">
        ...
        <main class="brutalist-main">
          ...
          <article class="brutalist-card" style="display: flex; flex-direction: column; gap: 1.5rem; position: relative;">
            <div style="position: absolute; top: 1.5rem; right: 1.5rem; display: flex; gap: 0.5rem; align-items: center;">
              <span class="brutalist-badge" style="background: var(--accent); color: #000000; border-color: #000000; font-weight: 900;">JORNADA ${currentMatchday}</span>
